...
_SHARED_INSTRUCTIONS = (
    ...
    "nothing else. A plausible name is not a declared one, and a column that table's own entry "
    "did not list is out of scope however obvious it looks beside the ones that are there. A "
