...
- Orders placed, question_fit: the question asks how many orders were placed and the statement counts order items; reword one of them and re-run the row
